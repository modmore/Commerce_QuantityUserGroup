...
if (!createObject('modNamespace',array(
    'name' => 'commerce_quantityusergroup',
    'path' => $componentPath.'/core/components/commerce_quantityusergroup/',
    'assets_path' => $componentPath.'/assets/components/commerce_quantityusergroup/',
),'name', false)) {
    echo "Error creating namespace commerce_quantityusergroup.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_quantityusergroup.core_path',
    'value' => $componentPath.'/core/components/commerce_quantityusergroup/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_quantityusergroup',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_quantityusergroup.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_quantityusergroup.assets_path',
    'value' => $componentPath.'/assets/components/commerce_quantityusergroup/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_quantityusergroup',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_quantityusergroup.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_quantityusergroup/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_quantityusergroup.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_quantityusergroup',
    'area' => 'Paths',
...
include $componentPath . '/core/components/commerce_quantityusergroup/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_quantityusergroup/src/';
...
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce_QuantityUserGroup\\', $modulePath);
